...
def load_data():
    ...
    """
    X = np.load( #image numpy file example: 'rebuilt_112_112_faces.npy')
    y = np.load( #numpy lables example:     'rebuilt_labels_encoded.npy')
...
def split_data(X, y, split_ratio=0.15):
    ...
    """
# image numpy array reshaped to be used in model
...
if __name__ == "__main__":
    ...
    with open('112history.json', 'w') as fp:
